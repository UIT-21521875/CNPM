...
BEGIN
    ...
    SELECT @next_mactud, TENCTUD, MOTA, NGBD, NGKT
    FROM inserted;
END;
INSERT INTO CTUUDAI (TENCTUD, MOTA, NGBD, NGKT)
VALUES ('Chương trình ưu đãi 1', 'Mô tả chương trình ưu đãi 1', '2023-01-01', '2023-12-31');
